  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <StatsCard title="Total Tasks Completed" value={totalTasksCompleted} icon={BookOpen} color="default" />
        <StatsCard title="Total Team Members" value={totalTeamMembers} icon={Users} color="default" />
        <StatsCard title="Average Score" value={avgScore} icon={Trophy} color="green" />
        <StatsCard title="Tasks Overdue" value={overdueTasks} icon={Clock} color="yellow" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
             <Card className="rounded-2xl shadow-none border-none">
                <CardHeader>
                    <CardTitle className="font-headline">Team Leaderboard</CardTitle>
                </CardHeader>
                <CardContent>
