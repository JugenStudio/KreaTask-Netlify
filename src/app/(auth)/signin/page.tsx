    ...
    <div className="w-full max-w-sm mx-auto flex flex-col items-center justify-center min-h-screen p-4">
      <div className="flex flex-col items-center text-center w-full space-y-12">
        <div className="space-y-4">
            <Image src="/sounds/logo2.png" alt="KreaTask Logo" width={100} height={100} className="mx-auto" />
            <h1 className="text-3xl font-bold font-headline text-white tracking-wider">KreaTask</h1>
        </div>

        <div className="w-full space-y-6">
            <p className="text-muted-foreground">Login to your account</p>
            
            <Button className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-teal-400 to-green-500 hover:from-teal-500 hover:to-green-600 text-white rounded-lg">
                SIGN IN
            </Button>
