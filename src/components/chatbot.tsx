...
export function Chatbot() {
  ...
  return (
    <>
      <Button
        className={cn(
          "fixed bottom-24 right-4 h-14 w-14 rounded-full shadow-lg z-50 md:bottom-6 md:right-6 bg-yellow-500 text-black hover:bg-yellow-600 transition-all active:scale-95"
        )}
        size="icon"
      ...
      <div
        className={cn(
          "fixed bottom-40 right-4 z-50 w-[calc(100vw-2rem)] max-w-sm rounded-2xl bg-card shadow-2xl border transition-all duration-300 ease-in-out md:bottom-24 md:right-6 card-glow",
          "h-[70vh] max-h-[600px]",
