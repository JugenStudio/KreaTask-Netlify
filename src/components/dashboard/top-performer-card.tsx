...
export function TopPerformerCard({ performer }: { performer: LeaderboardEntry }) {
  return (
    <Card className="rounded-2xl shadow-none border-none bg-secondary h-full">
      <CardHeader>
      ...
      <CardContent className="flex flex-col items-center text-center">
        ...
        <Badge className="bg-primary/10 text-primary hover:bg-primary/20 mb-6 font-semibold">
          {performer.tasksCompleted} Tasks Completed
        </Badge>
        <Button className="w-full rounded-full bg-primary/90 hover:bg-primary text-primary-foreground">
          View Profile
        </Button>
      </CardContent>
    </Card>
