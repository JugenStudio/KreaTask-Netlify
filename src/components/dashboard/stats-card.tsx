...
export function StatsCard({ 
  ...
  return (
    <Link href={href} className="flex group">
      <Card className="rounded-xl md:rounded-2xl shadow-sm border-border/80 h-full w-full transition-all duration-300 bg-card/80 hover:border-primary/50 card-spotlight">
