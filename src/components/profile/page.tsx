      ...
      <Card>
        ...
        <CardContent className="flex items-center gap-4 md:gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{currentUser.jabatan || t(`roles.${currentUser.role}` as any)}</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="role" defaultValue={currentUser.jabatan || t(`roles.${currentUser.role}` as any)} disabled />
          </div>
