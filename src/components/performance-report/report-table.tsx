          ...
          <Table className="table-fixed">
            <TableHeader className="bg-muted/50">
              <TableRow>
                ...
                <TableHead className="w-40 cursor-pointer hover:bg-muted">
                    <div className="flex items-center gap-1">
                        {t('report.table.employee')} <ArrowUpDown className="h-3 w-3" />
                    </div>
                </TableHead>
                <TableHead className="w-64">{t('report.table.task_title')}</TableHead>
                ...
                <TableHead className="w-80">{t('report.table.ai_justification')}</TableHead>
            ...
            <TableBody>
              {reportData.map((row) => (
                <TableRow key={row.id}>
                  ...
                  <TableCell className="break-words">{row.taskTitle[locale]}</TableCell>
                  ...
                  <TableCell className="break-words">{row.aiJustification[locale]}</TableCell>
