  ...
  if (tasks.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-48 text-center text-muted-foreground bg-secondary/50 rounded-xl md:rounded-2xl">
        <FileSearch className="h-10 w-10 md:h-12 md:w-12 mb-4" />
        <p className="font-semibold text-sm md:text-base">{t('report.history_panel.empty_title', {defaultValue: "No Tasks Found"})}</p>
